...
<head>
    ...
    <script type="text/javascript" src="/js/ubmod.js"></script>
</head>
<body>
<div class="header">
    <table style="width: 100%">
        <tr>
            <td><a href="/"><img src="/images/logo.png" style="border: 0px"/></a></td>
            <td valign="bottom" style="text-align: right"><a href="/about">About UBMoD</a></td>
        </tr>
    </table>
</div>
...
<div class="footer"><div class="footer-text">
    <table align="center"><tr>
        <td><a href="http://ubmod.sf.net"><img src="/images/ubmod_powered.png"/></a></td>
