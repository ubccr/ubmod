...
/**
 * User Data Access Object. Provides methods for retrieving data associated with
 * a user. A user's data is harvested from a given resource managers log files.
 */
public interface UserDao {
    /**
     * Fetches all user activity.
     * 
     * @param params
    ...
    /**
     * Fetches the total number of user activity records. This is used for
     * paging the Javascript grid
     * 
     * @param params
     *            default request params
     * @return The total number of user activity records
     */
    public Integer getAllUserActivityCount(DefaultParams params);

    /**
     * Fetches the activity for a give user
     * 
     * @param userId
     *            unique user id
     * @param params
     *            default request params
     * @return a map of user activity data
