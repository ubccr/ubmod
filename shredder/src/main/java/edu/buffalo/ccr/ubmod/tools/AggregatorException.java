...
/**
 * Exception class thrown by Aggregators when an error occurrs in the
 * aggregation process
 */
public class AggregatorException extends ToolsException {
    private static final long serialVersionUID = -1759452118918569759L;
